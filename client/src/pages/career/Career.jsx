...
const Career = React.memo(() => {
  ...
  =============================== */
  const revealConfig = useMemo(() => ({ threshold: 0.2, once: true }), []);
  ...
  const reasons = useMemo(
    () => [
      ...
      },
      {
        ...
        desc: "Build innovative solutions with modern technologies and creative freedom.",
      },
      {
        title: "Recognition & Rewards",
        desc: "We celebrate achievements and reward performance consistently.",
      },
    ],
    [],
  );
        ...
        <div className="u-container rtx-career-hero-layout">
          ...
          <div className="rtx-career-hero-content">
            ...
            <p
              ...
              style={{ "--delay": "0.5s" }}
            >
              Join a team where learning, ownership, and growth are part of
              everyday work. We believe meaningful careers are built through
              real impact, continuous learning, and strong collaboration.
            </p>
      ...
      >
        <div className="u-container rtx-career-life-layout">
          ...
          <div className="rtx-career-life-content">
            <h2 className="u-title u-drop" style={{ "--delay": "0.1s" }}>
            ...
            >
              ...
              and positive work environment leads to better ideas, stronger
              teams, and meaningful outcomes.
            </p>
        ...
        <div className="u-container">
          ...
          <div className="u-section-header">
            ...
            <p className="u-subtext u-drop" style={{ "--delay": "0.2s" }}>
              ...
              academics and industry by providing real project exposure and
              hands-on experience.
            </p>
          </div>
      ...
      >
        <div className="u-container">
          ...
          <div className="u-section-header">
            ...
            <p className="u-subtext u-drop" style={{ "--delay": "0.2s" }}>
              Explore current opportunities and find a role that fits your
        ...
        <div className="u-container">
          ...
          <div className="u-grid-auto">
            {growthPoints.map((item, index) => (
              ...
              >
                <h4 className="rtx-career-growth-title">{item.title}</h4>
                <p className="rtx-career-growth-text">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      >
        <div className="u-container-center">
          ...
          <p
            ...
            style={{ "--delay": "0.3s" }}
          >
            Explore open roles or share your resume with us. Even if you don’t
            see a position that fits right now, we’d still love to hear from
            you.
          </p>
